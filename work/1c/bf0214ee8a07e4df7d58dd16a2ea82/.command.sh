...
--population EUR \
--Zhead Zscore \
--out_name CHR06locus1.sorted.ld_out \
--position BP > CalcLD_1KG_VCF.CHR06locus1.sorted.out 2> CalcLD_1KG_VCF.CHR06locus1.sorted.err
