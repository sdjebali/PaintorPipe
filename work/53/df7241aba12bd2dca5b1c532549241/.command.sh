...
--population EUR \
--Zhead Zscore \
--out_name CHR10locus1.sorted.ld_out \
--position BP > CalcLD_1KG_VCF.CHR10locus1.sorted.out 2> CalcLD_1KG_VCF.CHR10locus1.sorted.err
