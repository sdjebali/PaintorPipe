...
--population EUR \
--Zhead Zscore \
--out_name CHR03locus2.sorted.ld_out \
--position BP > CalcLD_1KG_VCF.CHR03locus2.sorted.out 2> CalcLD_1KG_VCF.CHR03locus2.sorted.err
